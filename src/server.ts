...
function safeShutdown(intMaxWaitMS: number, fncCloseDown: () => Promise<void>)
{
	var shutDown : () => void = () =>
	{
...
function ServerSideEvents(req: express.Request, res : ExtendedResponse, nxt : express.NextFunction)
{
	res.sendEvent = (d : any) =>
	{
